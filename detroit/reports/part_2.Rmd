...
Under the current foreclosure crisis in Detroit that has been going on since 2011 it is pertinent that properties be assessed properly so as to not deepen the crisis but still maintain equity and revenue streams. Since previous studies of assessments have been determined to be inequitable 

```{r}
stats %>%
  ggplot() +
  geom_point(aes(x = Year, y = median_ratio, size = N)) +
